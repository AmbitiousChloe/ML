...
if __name__ == "__main__":
    ...
    Label = np.array(['Dubai', 'New York City', 'Rio de Janeiro', 'Paris', 'Rio de Janeiro', 'Dubai', 'Rio de Janeiro', 'New York City', 'Paris', 'Rio de Janeiro', 'Paris', 'New York City', 'Rio de Janeiro', 'Dubai', 'Rio de Janeiro', 'Paris', 'Dubai', 'Paris', 'Rio de Janeiro', 'Rio de Janeiro', 'Rio de Janeiro', 'Rio de Janeiro', 'Rio de Janeiro', 'Dubai', 'Rio de Janeiro', 'Paris', 'Rio de Janeiro', 'Dubai', 'Rio de Janeiro', 'Paris', 'Dubai', 'New York City', 'Dubai', 'Dubai', 'Paris', 'Paris', 'Dubai', 'New York City', 'Dubai', 'Paris', 'Paris', 'New York City', 'Dubai', 'Dubai', 'Dubai', 'Dubai', 'Rio de Janeiro', 'New York City', 'Rio de Janeiro', 'New York City', 'New York City', 'Rio de Janeiro', 'Paris', 'New York City', 'Rio de Janeiro', 'New York City', 'Paris', 'Paris', 'New York City', 'New York City', 'Paris', 'New York City', 'Paris', 'Dubai', 'Dubai', 'New York City', 'Rio de Janeiro', 'Rio de Janeiro', 'Rio de Janeiro', 'New York City', 'New York City', 'New York City', 'Dubai', 'Dubai', 'Paris', 'Rio de Janeiro', 'Rio de Janeiro', 'Dubai', 'Rio de Janeiro', 'Dubai', 'New York City', 'Paris', 'New York City', 'Paris', 'New York City', 'Dubai', 'Paris', 'Dubai', 'Dubai', 'Rio de Janeiro', 'Dubai', 'Rio de Janeiro', 'Rio de Janeiro', 'New York City', 'Dubai', 'New York City', 'Dubai', 'Paris', 'Rio de Janeiro', 'Paris'])
