...
def process_data(filename: str) -> pd.DataFrame:
    ...
    Q1_onehot = pd.get_dummies(df['Q1'], prefix='Q1', columns=Q1_Q4_all_categories, dtype=int)
    Q2_onehot = pd.get_dummies(df['Q2'], prefix='Q2', columns=Q1_Q4_all_categories, dtype=int)
    Q3_onehot = pd.get_dummies(df['Q3'], prefix='Q3', columns=Q1_Q4_all_categories, dtype=int)
    Q4_onehot = pd.get_dummies(df['Q4'], prefix='Q4', columns=Q1_Q4_all_categories, dtype=int)
